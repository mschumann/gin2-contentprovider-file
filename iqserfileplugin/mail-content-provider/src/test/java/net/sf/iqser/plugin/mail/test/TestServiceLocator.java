...
import net.sf.iqser.plugin.filesystem.FilesystemContentProvider;
...
public class TestServiceLocator implements ServiceLocator {
	...
	private FilesystemContentProvider createFileSystemContentProvider() {
...
//				.configure(new File("src/test/resources/iqser-config.xml"));
	...
	public ContentProvider getContentProvider(String arg0) {
		if (arg0.equalsIgnoreCase(FILESYSTEM_CONTENT_PROVIDER))
			return createFileSystemContentProvider();
		return null;
	}
